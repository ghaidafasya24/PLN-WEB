      ...
      <h3><i class="fas fa-user mr-2"></i> PELANGGAN </h3><hr>
         ...
         <form>
             <fieldset disabled>
                 ...
                 <div class="mb-3">
                     <label for="disabledTextInput" class="form-label"> No Meter</label>
                     <input type="text" id="disabledTextInput" class="form-control" placeholder="00808130">
                 </div>
                 <div class="mb-3">
                 ...
                 <div class="mb-3">
                      ...
                      <input type="text" id="disabledTextInput" class="form-control" placeholder="081900887683">
                 </div>
                 <div class="mb-3">    
                     <label for="inputpassword5" class="form-label text-dark" id="disabledTextInput">Kode Tarif</label>
                     <br>
                 ...
                 <div class="mb-3">
                      ...
                      <input type="text" id="disabledTextInput" class="form-control" placeholder="Bekasi Utara">
                 </div>
             </fieldset>
             <div class="mb-3">
                 <a href="pelanggan.php" class="btn btn-info text-light">Kembali</a>
         </form>
