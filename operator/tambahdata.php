...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-md-10 p-5 pt-2">
      <h3><i class="fas fa-user mr-2"></i> TAMBAH PELANGGAN </h3><hr>
             ...
             <form action="" method="post">
                 ...
                 <div class="mb-3">    
                     <label for="no_meter" class="form-label text-dark">No Meter</label>
                     <input type="text" name="no_meter" id="no_meter" class="form-control" placeholder="no meter">
                 </div>
                 <div class="mb-3">    
                 ...
                 <div class="mb-3">    
                     <label for="inputpassword5" class="form-label text-dark">No telepon</label>
                 ...
                 <div class="mb-3">    
                     <label for="inputpassword5" class="form-label text-dark">Alamat</label>
                     <input type="text" name="alamat" id="alamat" class="form-control" placeholder="alamat">
                 </div>
                 <div class="mb-3">
                 <a href="pelanggan.php" type="submit" name="submit" class="btn btn-info text-light">Submit</a> <a href="pelanggan.php" class="btn btn-success">Kembali</a> 
             </form>
