...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-md-10 p-5 pt-2">
      <h3><i class="fas fa-calendar-alt mr-2"></i> INPUT TARIF </h3><hr>
      
      <a href="tambahtarif.php" class="btn btn-primary mb-3"><i class="fas fa-user-plus mr-3"></i>INPUT TARIF</a>
