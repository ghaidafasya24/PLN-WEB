...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-info fixed-top">
      <a class="navbar-brand" href="#"><b> Pelanggan | WELCOME TO ELECTRIC PAYMENT </b></a>
            ...
            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown" style="color: black;">
                <div class="dropdown-header text-center">
                  ...
                  <p class="font-weight-light text-muted mb-0"></p> pelanggan</p>
                </div>
    ...
    <div class="col-md-10 p-5 pt-2">
      <h3><i class="fas fa-money-check-alt mr-2"></i>                                                                                                                                                                                    TAMBAH PEMBAYARAN </h3><hr>
             ...
             <form action="" method="post">
                 <div class="mb-3">    
                     <label for="id_pelanggan" class="form-label text-dark">ID Pelanggan</label>
                     <input type="text" name="id_pelanggan" id="id_pelanggan" required class="form-control" placeholder="id pelanggan">
                 </div>
                 ...
                 <div class="mb-3">    
                     <label for="inputpassword5" class="form-label text-dark">Jumlah Tagihan</label>
                     <input type="text" name="no_telepon" id="no_telepon" class="form-control" placeholder="jumlah tagihan">
                 </div>
                  
                 <div class="mb-3">
                 <a href="#" type="submit" name="submit" class="btn btn-info text-light">Submit</a> <a href="inputpembayaran.php" class="btn btn-success">Kembali</a> 
             </form>
