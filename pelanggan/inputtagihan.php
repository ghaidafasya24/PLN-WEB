...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-md-10 p-5 pt-2">
      <h3><i class="fas fa-file-invoice mr-2"></i> INPUT TAGIHAN </h3><hr>
             ...
             <form action="" method="post">
                 <div class="mb-3">    
                     <label for="id_pelanggan" class="form-label text-dark">No Meter</label>
                     <input type="text" name="id_pelanggan" id="id_pelanggan" required class="form-control" placeholder="id pelanggan">
                 </div>
                
                 <div class="mb-3">
                 <a href="inputpembayaran.php" type="submit" name="submit" class="btn btn-info text-light">Submit</a> <a href="inputpembayaran.php" type="submit" name="submit" class="btn btn-success text-light">Cancel</a>
             </form>
