...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-md-10 p-5 pt-2">
      ...
      <a href="" class="btn btn-primary mb-3"><i class="fas fa-user-plus mr-3"></i>INPUT PELANGGAN</a>
             ...
             <form action="" method="post"> 
                 <div class="mb-3">    
                     <label for="TextInput" class="form-label text-dark"> ID Pelanggan </label>
                     <input type="text" id="text" name="id_pelanggan" class="form-control" placeholder="192010379">
                 </div>
                 <div class="mb-3">    
                     <label for="TextInput" class="form-label text-dark">No Meter</label>
                     <input type="text" id="text" name="no_meter" class="form-control" placeholder="00808130">
                 </div>
                 <div class="mb-3">    
                     <label for="TextInput" class="form-label text-dark">Nama Pelanggan</label>
                     <input type="text" id="text" name="nama_pelanggan" class="form-control" placeholder="Abraham Putra">
                 </div>
                 <div class="mb-3">    
                     <label for="TextInput" class="form-label text-dark">No Telepon</label>
                     <input type="text" id="text" name="no_telepon" class="form-control" placeholder="081900887683">
                 </div>
                 <div class="mb-3">    
                 ...
                 <div class="mb-3">    
                     <label for="TextInput" class="form-label text-dark">Alamat</label>
                     <input type="text" id="text" class="form-control" placeholder="Bekasi Utara">
                 </div>
                 <div class="mb-3">
                 <a href="pelanggan.php" class="btn btn-info text-light">Submit</a> <a href="pelanggan.php" class="btn btn-success">Kembali</a> 
             </form>
