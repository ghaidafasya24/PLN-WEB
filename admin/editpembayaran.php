...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-md-10 p-5 pt-2">
      <h3><i class="fas fa-user mr-2"></i> INPUT PEMBAYARAN </h3><hr>
      
      <a href="" class="btn btn-primary mb-3"><i class="fas fa-user-plus mr-3"></i>INPUT PEMBAYARAN</a>
             ...
             <form action="" method="post"> 
                 ...
                 <div class="mb-3">    
                     <label for="TextInput" class="form-label text-dark">Jumlah Tagihan</label>
                     <input type="text" id="text" name="jumlah_tagihan" class="form-control" placeholder="Rp.200.000">
                 </div>
        
                 <div class="mb-3">    
                     <label for="TextInput" class="form-label text-dark">WAKTU BAYAR</label>
                     <input type="text" id="text" class="form-control" placeholder="20 April 2021">
                 </div>
                 <div class="mb-3">
                 <a href="inputpembayaran.php" class="btn btn-info text-light">Submit</a> <a href="inputpembayaran.php" class="btn btn-success">Kembali</a> 
             </form>
